...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (lightPosition.instance.isnightvalue)
        {
        ...
        if (isGrounded && !wasGrounded)
        {
            ...
            this.gameObject.GetComponent<Damageable>().damageMultiplier = 0.5f + current_Time / 72000f;
        }
    ...
    void HandleCharacterMovement()
    {
        ...
        // vertical camera rotation
        {
            ...
            flashlight.transform.localEulerAngles = new Vector3(m_CameraVerticalAngle, 0, 0);
        }
